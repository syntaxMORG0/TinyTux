savedcmd_arch/x86/entry/vdso/vdso32/sigreturn.o := gcc -Wp,-MMD,arch/x86/entry/vdso/vdso32/.sigreturn.o.d -nostdinc -I./arch/x86/include -I./arch/x86/include/generated -I./include -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -D__KERNEL__ -D__ASSEMBLY__ -m32 -DBUILD_VDSO32 -m32 -mregparm=0 -D__DISABLE_EXPORTS -DDISABLE_BRANCH_PROFILING -DBUILD_VDSO -I./arch/x86/entry/vdso/vdso32/.. -I. -O2 -fpic -fno-stack-protector -fno-omit-frame-pointer -foptimize-sibling-calls -fasynchronous-unwind-tables -fcf-protection=none    -DKBUILD_MODFILE='"arch/x86/entry/vdso/vdso32/sigreturn"' -DKBUILD_MODNAME='"sigreturn"' -D__KBUILD_MODNAME=sigreturn -c -o arch/x86/entry/vdso/vdso32/sigreturn.o arch/x86/entry/vdso/vdso32/sigreturn.S 
